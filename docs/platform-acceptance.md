...
- The actual browser viewport was approximately 762 CSS pixels wide. The browser viewport override did not change the page dimensions, so 390-pixel and full desktop visual acceptance remain unverified. Responsive classes alone are not proof of those viewport checks.
