...
export async function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative overflow-hidden bg-paper border-b border-ink-900/5 isolate"
    >
          ...
          <FadeIn className="md:col-span-7">
            ...
            <div className="mt-8 md:mt-9 flex flex-wrap items-center gap-3">
              ...
              >
                ...
                {isRtl ? "أنشئ مساحتك" : "Create your workspace"}
                {isRtl ? (
      ...
      <FadeIn
        delay={0.3}
        className="relative z-10 border-t border-ink-900/5 bg-paper/80 backdrop-blur-sm"
      >
