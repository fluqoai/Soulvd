...
export default function TemplatesPage() {
  return (
    <div>
      <PageHeader title="القوالب" description="Document templates used to generate invoices و quotes." />
      ...
      <div className="rounded-2xl border-2 border-dashed border-ink-900/10 bg-paper p-10 text-center max-w-2xl">
        ...
        <p className="text-base text-ink-600 max-w-md mx-auto">
          ...
          will let you record the field schema per template و generate <code className="text-xs bg-linen-100 px-1.5 py-0.5 rounded">.docx</code> + PDF
          on demo.
        </p>
        <ol className="text-start mt-6 space-y-2 text-sm text-ink-700 max-w-md mx-auto">
          ...
          <li className="flex gap-2"><span className="text-sage-600 font-semibold">4.</span> Generate from the Invoices or Quotes pages — server fills the placeholders, returns a <code className="text-xs">.docx</code> + PDF, و gives you a shareable link.</li>
        </ol>
