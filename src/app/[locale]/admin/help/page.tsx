...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'status', ar: 'الحالة: active (نشط) / inactive (متوقف) / archived (مؤرشف)', note: 'تظهر كزر في عمود الحالة — اضغط لتبديلها' },
    ],
    editSteps: [
      'افتح /admin/clients',
      'أضف عميلاً يدوياً، أو حوّل استفسار من /admin/leads',
      'املأ الاسم + الرقم الضريبي + العنوان (مطلوبة للفواتير)',
      'في صفحة التعديل، غيّر الحالة من القائمة (نشط/متوقف/مؤرشف) — أو اضغط على الشارة في القائمة لتبديلها بسرعة',
      'احفظ',
    ],
