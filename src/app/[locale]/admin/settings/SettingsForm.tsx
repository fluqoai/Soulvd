  ...
  return (
    <form action={formAction} className="space-y-8 max-w-2xl">
      <section className="space-y-4">
        ...
        <Field label="Tagline" hint="One-line description used in headers/footers">
      ...
      <section className="space-y-4">
        ...
        <Field label="Address"><TextInput name="address" defaultValue={row.address ?? ''} /></Field>
        <Field label="Working hours" hint='e.g. "Sunday - Thursday: 9 AM - 6 PM"'>
