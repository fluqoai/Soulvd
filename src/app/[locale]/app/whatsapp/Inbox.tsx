              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="mt-1.5 flex items-center gap-1.5">
                    {c.handoff_at && (
                      <span className="shrink-0 rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-bold text-amber-900" title={c.handoff_assignee_email ? `بانتظار ${c.handoff_assignee_email}` : 'بانتظار متابعة موظف'}>
                        متابعة موظف
                      </span>
                    )}
